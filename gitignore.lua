...
while PlayerGui:FindFirstChild("scriptPanel") and wait(1) do
	...
	if GameTabValues["wav cosmetic effects"].ImageButton.Active and game.Workspace:FindFirstChild(game.Players.LocalPlayer.Name) then if game.Workspace[game.Players.LocalPlayer.Name]:FindFirstChild("WavCrown") then  game.Workspace[game.Players.LocalPlayer.Name].WavCrown.Handle.Crystals.Script.Enabled = true end end
